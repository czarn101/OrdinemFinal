package com.Ordinem;// SQLConnector
...
public class SQLConnector {
    ...
    public void init() {
        ...
        try {
            ...
            System.out.println("User exceeded max connections");
        }catch(ClassNotFoundException e){
            System.out.println("Class jdbc driver not found");
    ...
    public String getSeperateCol(String[] attributes) throws Exception{
        ...
        */
        while (this.data.next()) {
            for (String attr : attributes) {
                output = this.data.getString(attr);
            }
            //output += "\n";
        }
        //return events;
    ...
    public ArrayList<String> getArrayCol(String[] attributes) throws Exception{
        ArrayList<String> events = new ArrayList<String>();
        ...
        */
        while (this.data.next()) {
            for (String attr : attributes){
                events.add(this.data.getString(attr));
            }
            //output += "\n";
        }
        //return events;
